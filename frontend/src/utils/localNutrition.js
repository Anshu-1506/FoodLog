import foodDB from '../data/foodDatabase.json';
const findFoodMatch = name => {
  const lower = name.toLowerCase().trim();
  return foodDB.find(f => f.name === lower || (f.aliases || []).includes(lower)) || null;
};
export const calculateNutritionLocal = items => {
